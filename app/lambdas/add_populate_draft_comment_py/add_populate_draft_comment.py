...
def handler(event: Dict[str, Any], context) -> Dict[str, bool]:
    ...
    Event shape:
    {
        ...
        "missingFields": ["inputs.caseMetadata", ...],  // only for no_change_missing_fields
